        ...
        String []trozos;
            ...
            try
            {
                ...
                while((linea = br.readLine())!=null)
                {
                    ...
                    Equipo e = null;
                    try {
                        e = new Equipo(trozos[0],Integer.parseInt(trozos[1].trim()),Integer.parseInt(trozos[2].trim()));
                    } catch (EPresupuestoIlegal ex) {
                        Logger.getLogger(TextoConIPersistencia.class.getName()).log(Level.SEVERE, null, ex);
                    }
