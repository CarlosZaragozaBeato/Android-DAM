...
/**
 * Representa un conjunto de art�culos que compra un socio. De un pedido se
 * almacena la fecha en que se realiza y el total a pagar, que se calcula en
 * funci�n del precio y cantidad de los art�culos que forman el pedido.
 */
enum EstadoPedido {
...
public class Pedido {
    ...
    public String toString() {
        String f = fecha.getTime()+"";
        String j = f.substring(0, 19);
        return idPedido+":"+socio.getNombre()+" ("+j+")";
    }
